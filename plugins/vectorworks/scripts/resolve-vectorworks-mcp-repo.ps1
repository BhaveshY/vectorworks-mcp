...
param(
    ...
    [ValidateRange(1, 100)]
    [int]$MinimumContractVersion = 17,
    [string[]]$RequiredFeatures = @("stable-loader", "loader-clipboard-copy", "native-bridge-scaffold", "native-bridge-scaffold-copy", "native-doctor-next-command", "native-doctor-command-spec", "native-bridge-project-wire", "native-doctor-next-runner", "native-runner-spec-validation", "native-sdk-archive-reuse", "native-vectorworks-auto-smoke", "native-phase0-transport", "native-phase1-cad-handlers", "native-phase2-cad-handlers", "native-phase2-set-property", "native-phase2-manage-classes", "native-phase4-apply-operations", "fast-native-tool-profile", "structured-mcp-results", "codex-plugin-package", "local-auth-token-required", "client-neutral-project-mcp", "native-documentation-lifecycle", "native-document-target-binding", "review-all-sheets")
)
