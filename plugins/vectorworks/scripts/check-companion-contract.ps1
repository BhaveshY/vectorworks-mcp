...
$RequiredFeatures = @("stable-loader", "loader-clipboard-copy", "native-bridge-scaffold", "native-bridge-scaffold-copy", "native-doctor-next-command", "native-doctor-command-spec", "native-bridge-project-wire", "native-doctor-next-runner", "native-runner-spec-validation", "native-sdk-archive-reuse", "native-vectorworks-auto-smoke", "native-phase0-transport", "native-phase1-cad-handlers", "native-phase2-cad-handlers", "native-phase2-set-property", "native-phase2-manage-classes", "local-auth-token-required", "client-neutral-project-mcp")
...
try {
    ...
    throw "Companion repo contract marker is incompatible. Expected numeric contractVersion >= 15."
}
if ($Contract.name -ne "vectorworks-mcp" -or $ContractVersion -lt 15) {
    throw "Companion repo contract marker is incompatible. Expected vectorworks-mcp contractVersion >= 15."
}
