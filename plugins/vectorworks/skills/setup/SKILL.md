...
- If Vectorworks hangs, the user is probably running a stale foreground launcher. Create `~\.vectorworks-mcp\STOP`, regenerate the launcher, and have them paste the new launcher into Vectorworks.
