...
constexpr std::array<ObjectKindSpec, 20> kObjectKindRegistry = {{
    ...
    {"dimension", "linear_dimension", "kDimensionNode", "available", R"({"required":[],"optional":["x1","y1","x2","y2","offset","text_offset","direction_x","direction_y","dimension_type","name","class_name"]})", "dimension node type and linear geometry readback"},
    {"linear_dimension", "linear_dimension", "kDimensionNode", "available", R"({"required":[],"optional":["x1","y1","x2","y2","offset","text_offset","direction_x","direction_y","dimension_type","name","class_name"]})", "dimension node type and linear geometry readback"},
