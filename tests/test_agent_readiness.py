...
class AgentReadinessTests(unittest.TestCase):
    ...
    def test_generated_launcher_uses_background_listener(self):
        register_script = (ROOT / "scripts/register-claude-code.ps1").read_text(encoding="utf-8")
        self.assertIn('os.environ["VW_MCP_BACKGROUND"] = "1"', register_script)
    ...
    def test_register_script_generates_background_launcher(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertIn('os.environ["VW_MCP_BACKGROUND"] = "1"', launcher_text)
