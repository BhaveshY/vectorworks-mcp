...
if ($LauncherText -notmatch 'os\.environ\["VW_MCP_BACKGROUND"\]\s*=\s*["'']1["'']') {
    throw "Generated Vectorworks launcher does not set VW_MCP_BACKGROUND=1; regenerate it with scripts\register-claude-code.ps1."
}
